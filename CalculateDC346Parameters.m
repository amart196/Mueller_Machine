function Ydata = CalculateDC346Parameters(Lam,d,MM1,MM2,MM3,MM4);
...
%Send in M12 for the reflection measurements and M12 for the oblique
%incidence transmission measurement

%Send in M23 for normal incidence transmission measurement
